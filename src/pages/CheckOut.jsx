...
const CheckOut = () => {
    ...
    // Total Amount Logic: Subtotal + Delivery - Discount
    const AmountWithDeliveryFee = Math.max(0, totalAmount - discountAmount + deliveryFee);
    ...
    const getAddressByLatLng = async (lat, lng) => {
        try {
            const result = await axios.get(`https://api.geoapify.com/v1/geocode/reverse?lat=${lat}&lon=${lng}&format=json&apiKey=${import.meta.env.VITE_GEOAPI_KEY}`);
    ...
    const getLatLngByAddress = async () => {
        try {
            const result = await axios.get(`https://api.geoapify.com/v1/geocode/search?text=${encodeURIComponent(addressInput)}&apiKey=${import.meta.env.VITE_GEOAPI_KEY}`);
    ...
    const handlePlaceOrder = async () => {
        try {
            const result = await axios.post(`${serverUrl}api/order/place-order`, {
                ...
                cartItems,
                couponCode, // Pass coupon info
                discountAmount // Pass coupon info
            }, {
    ...
    return (
        <div
            className='min-h-screen bg-[#fff9f6] flex items-center justify-center p-6'>
            ...
            <div className='w-full max-w-[900px] bg-white rounded-2xl shadow-xl p-6 space-y-6'>
                ...
                <section>
                    ...
                    <div className='flex gap-2 mb-3'>
                        ...
                        <button
                            ...
                            className='bg-blue-500 hover:bg-blue-600 text-white px-3 py-2 rounded-lg flex itemcs-center justify-center'>
                            <TbCurrentLocation className='pt-1' size={20} />
                        </button>
                    </div>
                ...
                <button
                    className='w-full bg-[#ff4d2d] hover:bg-[#e64526] text-white py-3 font-semibold roundex-xl'
